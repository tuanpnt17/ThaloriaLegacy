...
namespace Assets.Scrips.HttpRequest
{
    public abstract class ApiCall
    {
        ...
        /// <returns></returns>
        public virtual IEnumerator JsonGet(
            string uri,
            string jsonString = "{}",
            Action<UnityWebRequest, string> callback = null
        )
        {
        ...
        /// <param name="callback"></param>
        /// <returns></returns>
        public virtual IEnumerator JsonPost(
            string uri,
            string jsonString = "{}",
            Action<UnityWebRequest, string> callback = null
        )
        ...
        /// <param name="callback"></param>
        /// <returns></returns>
        public virtual IEnumerator JsonPut(
            string uri,
            string jsonString = "{}",
            Action<UnityWebRequest, string> callback = null
        )
        ...
        /// <param name="callback"></param>
        /// <returns></returns>
        public virtual IEnumerator RequestJson(
            string method,
            string uri,
            string jsonString,
            Action<UnityWebRequest, string> callback = null
        )
        {
            ...
            if (callback == null)
            {
                if (request.result == UnityWebRequest.Result.Success)
                    this.OnRequestSuccess(request, this.jsonStringResponse);
                else
                    this.OnRequestError(request, this.jsonStringResponse);
            }
            else
            {
