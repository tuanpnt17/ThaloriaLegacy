...
public class AudioManager : MonoBehaviour
{
    ...
    [SerializeField]
    private AudioSource powerBallAudioSource;
    ...
    [SerializeField]
    private AudioClip enegyClip;

    [SerializeField]
    private AudioClip mainMenuClip;

    [SerializeField]
    private AudioClip map1Clip;

    [SerializeField]
    private AudioClip map2Clip;

    [SerializeField]
    private AudioClip map3Clip;

    [SerializeField]
    private AudioClip map4Clip;

    [SerializeField]
    private AudioClip mapEndClip;
    ...
    [SerializeField]
    private AudioClip enemyClip1;

    [SerializeField]
    private AudioClip enemyClip2;

    [SerializeField]
    private AudioClip enemyClip3;

    [SerializeField]
    private AudioClip enemyWizardClip;

    [SerializeField]
    private AudioClip enemyArcherClip;

    [SerializeField]
    private AudioClip enemySlashClip;

    [SerializeField]
    private AudioClip enemyAxeClip;

    [SerializeField]
    private AudioClip enemyExplosionClip;

    [SerializeField]
    private AudioClip dragonBossClip;

    [SerializeField]
    private AudioClip dragonBossAttackClip;

    [SerializeField]
    private AudioClip roboticBossClip;

    [SerializeField]
    private AudioClip golemBossClip;

    [SerializeField]
    private AudioClip pharaohBossClip;

    [SerializeField]
    private AudioClip pharaohBossAttackClip;

    [SerializeField]
    private AudioClip frostBossClip;

    [SerializeField]
    private AudioClip frostBossAttackClip;
